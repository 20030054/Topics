...
HeartBeatMessage::HeartBeatMessage(const char *name, short kind) : ::veins::BaseFrame1609_4(name,kind)
{
...
HeartBeatMessage::HeartBeatMessage(const HeartBeatMessage& other) : ::veins::BaseFrame1609_4(other)
{
    copy(other);
}
...
LAddress::L2Type& HeartBeatMessage::getSenderAddress()
{
    return this->senderAddress;
}

void HeartBeatMessage::setSenderAddress(const LAddress::L2Type& senderAddress)
{
    this->senderAddress = senderAddress;
}

const char * HeartBeatMessage::getMessageID() const
{
    return this->messageID.c_str();
}

void HeartBeatMessage::setMessageID(const char * messageID)
{
    this->messageID = messageID;
}

int HeartBeatMessage::getSerial() const
{
    return this->serial;
}

void HeartBeatMessage::setSerial(int serial)
{
    this->serial = serial;
}

int HeartBeatMessage::getReceipeintID() const
{
    return this->receipeintID;
}

void HeartBeatMessage::setReceipeintID(int receipeintID)
{
    this->receipeintID = receipeintID;
}

int HeartBeatMessage::getSenderID() const
{
    return this->senderID;
}

void HeartBeatMessage::setSenderID(int senderID)
{
    this->senderID = senderID;
}

Coord& HeartBeatMessage::getPosition()
{
    return this->position;
}

void HeartBeatMessage::setPosition(const Coord& position)
{
...
HeartBeatMessageDescriptor::HeartBeatMessageDescriptor() : omnetpp::cClassDescriptor("veins::HeartBeatMessage", "veins::BaseFrame1609_4")
{
...
int HeartBeatMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='r' && strcmp(fieldName, "receipeintID")==0) return base+3;
...
int HeartBeatMessageDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    HeartBeatMessage *pp = (HeartBeatMessage *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *HeartBeatMessageDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string HeartBeatMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 3: return long2string(pp->getReceipeintID());
...
bool HeartBeatMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 3: pp->setReceipeintID(string2long(value)); return true;
...
void *HeartBeatMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
