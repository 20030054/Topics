...
class VEINS_API TraCIDemo11pMessage : public ::veins::BaseFrame1609_4
{
  ...
  public:
    ...
    virtual void setDriverName(const char * driverName);
    ...
    virtual const Coord& getPosition() const {return const_cast<TraCIDemo11pMessage*>(this)->getPosition();}
    ...
    virtual double getNodeSpeed() const;
    virtual void setNodeSpeed(double NodeSpeed);
    virtual int getTaskPriority() const;
    virtual void setTaskPriority(int taskPriority);
};
