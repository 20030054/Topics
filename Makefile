...
OBJS = \
    ...
    $O/veins/modules/application/traci/Node.o \
    $O/veins/modules/application/traci/Task.o \
    $O/veins/modules/application/traci/TraCICar.o \
    ...
    $O/veins/modules/application/traci/HeartBeatMessage_m.o \
...
MSGFILES = \
    ...
    veins/modules/application/traci/HeartBeatMessage.msg \
